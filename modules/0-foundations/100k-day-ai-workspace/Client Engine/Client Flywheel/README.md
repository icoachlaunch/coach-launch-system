# Client Flywheel™ — Pillar 3 · Steps 7–9
**Traffic and marketing** — fill the machine, so your Offer Matrix™ and Money Magnet™ never run dry.
...
When a builder ships, run it from **Coach Launch Academy™** — download from your Training Portal,
paste into a fresh chat, run. Save the finished asset in its folder here as the one canonical file.
Never a -v2.
